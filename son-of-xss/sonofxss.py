'''
SonOfXSS
This project was created by Zer0S1m2t.
'''
import argparse
...
epilog="""
Github: https://www.github.com/0s1mt
Discord: darkgarden
"""
def check(getopt):
...
def start():
	parse=argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,usage="Son-OF-XSS -u <target> [options]",epilog=epilog,add_help=False)
